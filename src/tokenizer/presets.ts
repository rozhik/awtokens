...
export const standardCallbacks: TokenizerInit = (addRegexp, addCallback) => {
  urlsCallbacks(addRegexp, addCallback);
  dataCallbacks(addRegexp, addCallback);
  charTypeCallbacks(addRegexp, addCallback);
};
